  ...
  function maybe_connect (cb) {
    ...
    if (connection != null && !forceNewConnection) {
      ...
      var connect_with_retry = function(i) {
        //console.log("Try connecting to MongoDB by address: " + env.storageURI);
        //console.log("Try new way....");
        //var clnt = new MongoClient(env.storageURI, { useNewUrlParser: true });
        /*clnt.connect(err => {
          console.log(err);
          const collection = clnt.db("test").collection("devices");
          console.log("New way connect successfull");
          clnt.close();
        });*/
